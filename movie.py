...
icon_logo = Image.open("moviepa.png")
# Run streamlit in wide screen mode
st.set_page_config(page_title="My Recommender | Home", page_icon=icon_logo, layout="wide")
...
my_api_key = "f951740fcf5013723597ed5fb617df6f"
...
heading = '<h1 style="color: hotpink;">RECOMMENDER SYSTEM</h1>'
st.markdown(heading, unsafe_allow_html=True)
subheading = '<p style="color:white; font-size: 20px;"> <span style="color:palevioletred;"><br>Mr. Recommendo will give you similar flicks!!!</span></p>'
st.markdown(subheading, unsafe_allow_html=True)

sec1, sec2 = st.columns(2)

with sec1:
    selected_movie_name = st.selectbox("What would You Like To See", movies["title"].values)
with sec2:
    pass
